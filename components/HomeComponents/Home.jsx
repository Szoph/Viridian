...
{/* Oak and Iron Staircase Picture */}
<div className='w-full'>
  <Image 
  src='/Stairs1.jpg'
  alt='Oak and Iron staircase in Rotherham'
  width={700}
  height={1600}
...
<div className=' w-full h-full max-w-sm'>
 <Image 
 src='/MediaWalls/MediaWall7.jpg'
 width={700}
 height={1600}
 alt='Media Wall in Rotherham'
 className='w-full h-full object-cover mx-auto shadow-lg'
 />
